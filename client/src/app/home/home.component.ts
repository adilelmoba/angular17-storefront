...
export class HomeComponent { 
  ...
  toggleDeletePopup(product: Product) {
    if(!product.id) return console.error("No product id");
  ...
  onConfirmEdit(product: Product) {
    if(!this.selectedProduct.id) return console.error("No product id");
  ...
  onProductOutput(product: Product) {
    console.log(product, 'Output from product component')
  }
